...
const cloudtopRun: LevelDefinition = {
  ...
  tutorials: [
    ...
    {id:'castle-gate',z:-164,text:'A lever opens the castle gate — check the left side'},
  ],
  props: [
    ...
    {asset:'tower',pos:[-8,7,-178],height:6.5,rotY:.5},{asset:'tower',pos:[8,7,-178],height:6.5,rotY:-.5},
    {asset:'bush',pos:[-7,7,-188],height:1.7},{asset:'bush',pos:[7,7,-190],height:1.6},
    {asset:'flag',pos:[-9,7,-183],height:3.2,rotY:.3},{asset:'flag',pos:[9,7,-183],height:3.2,rotY:-.3},
  ],
  gateMechanism: {
    door: {asset:'door', pos:[0,7,-175.2], height:5.4, rotY:0},
    lever: {asset:'lever', pos:[-3.6,7,-175.2], height:1.65, rotY:1.5708},
    collider: {pos:[0,9.45,-175.2], size:[4.6,4.9,.85]},
    gear: [0,13.5,-175.2],
    triggerRadius: 1.45,
    portalCenterX: 0,
    portalWidth: 19,
